...
import {
  SummaryCreate, SummaryGetByQuery, SummaryGetById, SummaryUpdate, SummaryDelete,
...
export class WorkTimeController {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('summary')
  async create(@Body() dto: Omit<SummaryCreate.Request, 'userId'>, @UserId() userId: string): Promise<SummaryCreate.Response | undefined> {
    try {
  ...
  @UseGuards(JwtAuthGuard)
  @Patch('summary/:id')
  async update(@Param('id') id: string, @Body() dto: Omit<SummaryUpdate.Request, 'id'>): Promise<SummaryUpdate.Response | undefined> {
    try {
  ...
  @UseGuards(JwtAuthGuard)
  @Get('summary')
  async getByQuery(@Query() dto: Omit<SummaryGetByQuery.Request, 'userId'>, @UserId() userId: string): Promise<SummaryGetByQuery.Response | undefined> {
    try {
  ...
  @UseGuards(JwtAuthGuard)
  @Get('summary/:id')
  async getById(@Param('id') id: string): Promise<SummaryGetById.Response | undefined> {
    try {
  ...
  @UseGuards(JwtAuthGuard)
  @Delete('summary/:id')
  async delete(@Param('id') id: string): Promise<SummaryDelete.Response | undefined> {
    try {
